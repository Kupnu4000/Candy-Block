...
namespace UnityEngine {
    ...
    public class RuleTile : TileBase {
        ...
        public override void GetTileData (Vector3Int position, ITilemap tilemap, ref TileData tileData) {
            ...
            foreach (TilingRule rule in m_TilingRules) {
                ...
                if (RuleMatches(rule, ref neighboringTiles, ref transform)) {
                    ...
                    m_GameObjectQuaternion = Quaternion.LookRotation(
        ...
        protected virtual Matrix4x4 ApplyRandomTransform (TilingRule.Transform type, Matrix4x4 original,
        ...
        protected virtual void GetMatchingNeighboringTiles (ITilemap tilemap, Vector3Int position,
