...
namespace UnityEngine {
    ...
    public class RuleOverrideTile : TileBase {
        ...
        public RuleTile.TilingRule this [RuleTile.TilingRule originalRule] {
            ...
            set {
                ...
                if (value == null) {
                    ...
                    while (m_OverrideTilingRules.Count > 0 &&
                           !m_OverrideTilingRules[m_OverrideTilingRules.Count - 1].m_Enabled)
        ...
        public void GetOverrides (List <KeyValuePair <RuleTile.TilingRule, RuleTile.TilingRule>> overrides) {
            ...
            overrides.Add(
                new KeyValuePair <RuleTile.TilingRule, RuleTile.TilingRule>(m_OriginalDefault,
                    m_OverrideDefault.m_TilingRule));
        }
